...
function rectToMap(rect) {
  ...
  const canvasLeft = bounds.left;
  const canvasTop = bounds.top;
  return {
    left:
      (rect.left - canvasLeft - mapTransformState.x) / mapTransformState.k,
    right:
      (rect.right - canvasLeft - mapTransformState.x) /
      mapTransformState.k,
    top:
      (rect.top - canvasTop - mapTransformState.y) / mapTransformState.k,
    bottom:
      (rect.bottom - canvasTop - mapTransformState.y) /
      mapTransformState.k,
  };
}
function fieldAnchor(systemName, fieldName, side = 'right') {
  ...
  const x = (xAbs - canvasLeft - mtsSource.x) / scale;
  const y = (yAbs - canvasTop  - mtsSource.y) / scale;
