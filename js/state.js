  ...
  glossaryTerms: [
    {
      id: 'gls-001',
      term: 'Global ID',
      definition: 'Unique ID of Employee at LEONI',
      info: 'Created in IDM',
      owner: 'HR Analytics',
      fieldRef: '',
      fieldRefId: '',
    ...
    },
    {
      id: 'gls-002',
      term: 'Org-Code',
      definition: 'Shows the organizational allocation of a position',
      info: 'As shown in Org-Man',
      owner: 'Org Dev',
      fieldRef: '',
      fieldRefId: '',
      type: 'Term',
    },
    {
      id: 'gls-003',
      term: 'Position ID',
      definition: 'Unique Position ID within LEONI',
      info: 'Starts with X_',
      owner: 'HR Analytics',
      fieldRef: '',
      fieldRefId: '',
    ...
    },
    {
      id: 'gls-004',
      term: 'Status',
      definition: 'Shows if the employee is active or passive',
      info: '',
      owner: 'HR Analytics',
      fieldRef: '',
      fieldRefId: '',
    ...
    },
    {
      id: 'gls-005',
      term: 'Working Hours',
      definition: 'Contractual working hours of the employee',
      info: '',
      owner: 'HR Analytics',
      fieldRef: '',
      fieldRefId: '',
    ...
    {
      id: 'gls-006',
      term: 'Time to recruit',
      definition: 'Time from final approval of PR until contract signed',
      info: '',
      owner: 'HR Analytics',
      fieldRef: '',
      fieldRefId: '',
